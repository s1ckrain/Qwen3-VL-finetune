...
NAVAGENT_LABELED_DIR="${NAVAGENT_LABELED_DIR:-/root/data1/SFT-goat/labeled}"
NAVAGENT_RAW_DIR="${NAVAGENT_RAW_DIR:-/root/data1/SFT-goat/raw}"
NAVAGENT_QWENVL_DATA_DIR="${NAVAGENT_QWENVL_DATA_DIR:-/root/data1/SFT-goat/qwenvl}"
